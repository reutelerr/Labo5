...
unsigned int entreeCorrect(string AskingMessage, string ErrorMessage, unsigned int borneMin, unsigned int borneMax) {
...
int main() {
   unsigned int yearToDisplay = entreeCorrect("Quelle annee voulez-vous afficher? (1600-3000)", "Entree non valide", 1600, 3000);

   unsigned int dayToDisplay = entreeCorrect("Quelle jour de la semaine est le lundi? (1-7)", "Entree non valide", 1, 7);
